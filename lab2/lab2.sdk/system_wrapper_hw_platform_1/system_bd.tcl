...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {8} CONFIG.GPIO_BOARD_INTERFACE {SWs_8Bits} CONFIG.USE_BOARD_FLOW {true}  ] $sw_8bit
